...
class Grid(CMakePackage):
    """The LQCD Project aims at developing an efficient implementation of a stencil 
      for performing calculations for understanding the interactions between quarks and gluons. For understanding performance tradeoffs of key part of the computation in the application, a cutdown version of the Grid program was developed. 
     A key goal of this code is to understand how well OpenMP offloading features perform, and (2) to suggest to compilers that they have a performance problem 
     and (3) identify new features that compiler developers would like to see.  
      This package provides a 
       way for using the gridMini code within a test suite of other miniApps (which itself will be packaged) with different compilers and runtime system parameters 
       its implementation, in particular parameters for libraries for shared memory, on-node parallelism.  
    """

    homepage = 'https://www.bnl.gov/compsci/projects/'
    git      = "https://github.com/meifeng/Grid-OMP/"
